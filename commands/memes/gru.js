...
class GruCommand extends Command {
    ...
    async run({ message, bot, reply, t }) {
        ...
        if (!txt) return reply.fail("Minimo de 3 textos.")
    ...
    arg = {
        type: "string",
        info: "O texto é delimitado por `|`",
        example: "Encontra um exemplo do gru | Cria um gerador do meme do gru | Ninguém o usa"
    };
    cooldown = 5;
}
